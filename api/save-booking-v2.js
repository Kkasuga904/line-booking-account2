...
// Version: 2.0.0 - Unique filename to bypass cache
...
exports.default = async function handler(req, res) {
  console.log(`=== Account 2 Save Booking API v2.0.0 ===`);
  ...
  try {
    ...
    // Create reservation object with explicit store_id
    const reservation = {
      store_id: STORE_ID,
      date: date,
      time: time,
    ...
    console.log('Inserting reservation with store_id:', reservation.store_id);
    ...
    console.log('✅ Reservation saved successfully with ID:', data.id);
