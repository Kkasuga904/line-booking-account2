// Account 2 Reservation Save API - CommonJS Version
// Version: 1.0.0 - Using .cjs extension
...
module.exports = async function handler(req, res) {
  console.log(`=== Account 2 Save Reservation API v1.0.0 ===`);
  ...
  try {
    ...
    console.log('Inserting reservation for store:', STORE_ID);
